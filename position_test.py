...
def main():
    ...
    test_output_dir = os.path.join(
        os.path.dirname(__file__), "generated_reports", "test_batch"
    )
    ...
    bill_data = {
        ...
        "store_amount": 1234.56,
        "original_price": 10000.00,         # 新增：原始总收入
        "refund_amount": 500.00,             # 新增：退款金额
        "product_tax_fee": 200.00,           # 新增：GST，对应product_tax_fee
        "commission_fee": 300.00,            # 新增：佣金
        "refund_commission_fee": 50.00,      # 新增：退款佣金
        "service_package_fee": 20.00,        # 新增：服务包费用
        "total_orders": 10,  # 将在 ReportGenerator 中覆盖
        "total_revenue": 7890.12,  # 将在 ReportGenerator 中覆盖
    }
    

    store_info = {"id": 1, "name": "Test Store", "address": "123 Test St."}
